...
public interface ResponseMessage {
  ...
  interface Message {
    ...
    String ERROR_RATE_LIMIT_EXCEEDED =
            "Please try again later, you have exceeded per {0} OTP limit!!!";
    ...
    String EVENT_USER_NOT_ELIGIBLE_FOR_ENROLLMENT = "You are not eligible to enrol into this event.";
  ...
  interface Key {
    ...
    String EVENT_BATCH_ALREADY_COMPLETED = "EVENT_BATCH_ALREADY_COMPLETED";
    ...
    String EVENT_USER_NOT_ELIGIBLE_FOR_ENROLLMENT = "EVENT_USER_NOT_ELIGIBLE_FOR_ENROLLMENT";
  }
}
