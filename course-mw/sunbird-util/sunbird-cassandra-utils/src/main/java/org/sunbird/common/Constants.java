...
public interface Constants {
    ...
    public static final String EXCEPTION_COULDNT_SEND_EMAIL = "Exception occurred while sending automated emails";
    public static final String EXCEPTION_IN_EMAIL_SCHEDULER_MANAGER = "Exception in Email Scheduler Manager: Exception occurred while sending automated emails %s";
